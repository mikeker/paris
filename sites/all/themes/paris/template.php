 ...
 */
function paris_preprocess_html(&$vars) {
 ...
 */
function paris_html_head_alter(&$head_elements) {
 ...
 */
function paris_preprocess_username(&$vars) {
 ...
 */
function paris_breadcrumb($vars) {
 ...
 */
function paris_preprocess_page(&$vars, $hook) {
 ...
 */
function paris_menu_local_tasks(&$vars) {
  $output = '';
 ...
 */
function paris_page_alter($page) {
